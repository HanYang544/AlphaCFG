...
def set_seed(seed):
    ...
    torch.backends.cudnn.benchmark = False     # Set to True if network input dimensions or types don't vary much
...
def main():
    ...
    try:
        ...
        # If you want to create a new file each time, use 'w' mode, this example appends directly
        ...
        for iteration in range(1, NUM_ITERATIONS + 1):
            ...
            if pool.size >0:
                    ...
                    # Write results along with iteration to logs/pool_dicts.json
