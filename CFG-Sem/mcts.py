...
def apply_dirichlet_noise(root, epsilon=0.25, alpha=0.03):
    """
    Apply Dirichlet noise to the children of the root node to adjust prior probabilities.

    Parameters:
    root: The current node, containing children and original prior probabilities
    epsilon: The noise ratio, controlling the combination ratio of original priors and noise
    alpha: The parameter of the Dirichlet distribution, controlling the noise distribution
    """
